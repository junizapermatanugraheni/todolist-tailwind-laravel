...
<x-app-layout>
    ...
    <div class="flex flex-row sm:flex-col md:flex-col lg:flex-row gap-4 mt-5">
        <div
            ...
            <div class="flex flex-col">
                <span
                    ...
                    Design</span>
                <span class="text-xl font-bold text-gray-900 dark:text-white">Admin E-Commerce Design</span>
                <span
                    class="text-sm font-extralight text-gray-500 dark:text-slate-300 mt-2 mb-3 break-words max-w-64">This
                    project focuses
                    on
                    redesigning the
        ...
        <div
            ...
            <div class="flex flex-col">
                <span
                    class="bg-blue-100 text-blue-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-lg dark:bg-blue-900 dark:text-blue-300 mb-6 inline-flex w-fit">UI
                    Design</span>
                <span class="text-xl font-bold text-gray-900 dark:text-white">Setting Page Design</span>
                <span
                    class="text-sm font-extralight text-gray-500 dark:text-slate-300 mt-2 mb-3 break-words max-w-64">This
                    project focuses
                    on
